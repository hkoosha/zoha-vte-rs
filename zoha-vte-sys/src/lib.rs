...
use cairo::ffi::cairo_font_options_t;
...
extern "C" {
    ...
    #[cfg(feature = "v0_62")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_62")))]
    pub fn vte_terminal_event_check_regex_array(terminal: *mut VteTerminal, event: *mut gdk::GdkEvent, regexes: *mut *mut VteRegex, n_regexes: size_t, match_flags: u32, n_matches: *mut size_t) -> *mut *mut c_char;
    #[cfg(feature = "v0_46")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_46")))]
    ...
    pub fn vte_terminal_get_font_options(terminal: *mut VteTerminal) -> *const cairo::cairo_font_options_t;
    ...
    #[cfg(feature = "v0_74")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_74")))]
    pub fn vte_terminal_set_font_options(terminal: *mut VteTerminal, font_options: *const cairo::cairo_font_options_t);
