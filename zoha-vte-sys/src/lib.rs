...
extern "C" {
    ...
    pub fn vte_terminal_get_font_options(terminal: *mut VteTerminal) -> *const cairo_font_options_t;
    ...
    #[cfg(feature = "v0_74")]
    #[cfg_attr(docsrs, doc(cfg(feature = "v0_74")))]
    pub fn vte_terminal_set_font_options(terminal: *mut VteTerminal, font_options: *const cairo_font_options_t);
